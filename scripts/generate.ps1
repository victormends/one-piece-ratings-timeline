...
<body>
  ...
  <script>
    ...
    function matchesFilters(e) {
      ...
      if (searchQuery && !e.title.toLowerCase().includes(searchQuery) && !e.displayCode.toLowerCase().includes(searchQuery) && !(e.originalNote && e.originalNote.toLowerCase().includes(searchQuery))) return false;
      return true;
    }
